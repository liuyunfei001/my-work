...
COMMENT ON COLUMN sys_dict.pid IS '上级ID，一级为0';
...
COMMENT ON COLUMN sys_dict.updater IS '更新者';
...
COMMENT ON COLUMN sys_sms.mobile IS '手机号';
COMMENT ON COLUMN sys_sms.params_1 IS '参数1';
COMMENT ON COLUMN sys_sms.params_2 IS '参数2';
COMMENT ON COLUMN sys_sms.params_3 IS '参数3';
COMMENT ON COLUMN sys_sms.params_4 IS '参数4';
COMMENT ON COLUMN sys_sms.status IS '发送状态  0：失败  1：成功';
...
INSERT INTO sys_menu(id, pid, url, permissions, type, icon, sort, creator, create_date, updater, update_date) VALUES (1067246875800000041, 1067246875800000035, 'sys/dict', NULL, 0, 'icon-golden-fill', 2, 1067246875800000001, CURRENT_DATE, 1067246875800000001, CURRENT_DATE);
...
INSERT INTO sys_dict(id, pid, dict_type, dict_name, dict_value, remark, sort, creator, create_date, updater, update_date) VALUES (1067246875800000069, '0', 'gender', '性别', '', '', 0, 1067246875800000001, CURRENT_DATE, 1067246875800000001, CURRENT_DATE);
INSERT INTO sys_dict(id, pid, dict_type, dict_name, dict_value, remark, sort, creator, create_date, updater, update_date) VALUES (1067246875800000070, 1067246875800000069, 'gender', '男', '0', '', 0, 1067246875800000001, CURRENT_DATE, 1067246875800000001, CURRENT_DATE);
INSERT INTO sys_dict(id, pid, dict_type, dict_name, dict_value, remark, sort, creator, create_date, updater, update_date) VALUES (1067246875800000071, 1067246875800000069, 'gender', '女', '1', '', 1, 1067246875800000001, CURRENT_DATE, 1067246875800000001, CURRENT_DATE);
INSERT INTO sys_dict(id, pid, dict_type, dict_name, dict_value, remark, sort, creator, create_date, updater, update_date) VALUES (1067246875800000072, 1067246875800000069, 'gender', '保密', '2', '', 2, 1067246875800000001, CURRENT_DATE, 1067246875800000001, CURRENT_DATE);
...
INSERT INTO sys_params(id, param_code, param_value, param_type, remark, creator, create_date, updater, update_date) VALUES (1067246875800000074, 'SMS_CONFIG_KEY', '{"platform":1,"aliyunAccessKeyId":"1","aliyunAccessKeySecret":"1","aliyunSignName":"1","aliyunTemplateCode":"1","qcloudAppId":2,"qcloudAppKey":"2","qcloudSignName":"2","qcloudTemplateId":"2"}', 0, '短信配置信息', 1067246875800000001, CURRENT_DATE, 1067246875800000001, CURRENT_DATE);
